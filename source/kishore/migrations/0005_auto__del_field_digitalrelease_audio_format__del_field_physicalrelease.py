...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DigitalRelease.audio_format'
        db.delete_column('kishore_digitalreleases', 'audio_format')

        # Deleting field 'PhysicalRelease.release_format'
        db.delete_column('kishore_physicalreleases', 'release_format')


    def backwards(self, orm):
        # Adding field 'DigitalRelease.audio_format'
        db.add_column('kishore_digitalreleases', 'audio_format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'PhysicalRelease.release_format'
        db.add_column('kishore_physicalreleases', 'release_format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
