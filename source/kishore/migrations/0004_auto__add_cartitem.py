...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kishore_cartitems', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kishore.Cart'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kishore.Product'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('unit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
        ))
        db.send_create_signal('kishore', ['CartItem'])


    def backwards(self, orm):
        # Deleting model 'CartItem'
        db.delete_table('kishore_cartitems')
