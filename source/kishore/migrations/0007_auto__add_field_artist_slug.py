...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kishore_artists', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='twin-sister', unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.slug'
        db.delete_column('kishore_artists', 'slug')
    ...
    models = {
        ...
        'kishore.release': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
